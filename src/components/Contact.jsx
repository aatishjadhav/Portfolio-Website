...
const Contact = () => {
  let social = [
    {
      ...
      link: "https://www.linkedin.com/in/atish-jadhav07/",
    },
    {
      id: 2,
      color: "bg-gray-600",
  ...
  return (
    <div
      name="Contact"
      className="w-full sm:h-screen bg-gradient-to-b from-black to-gray-800 text-white p-4 pt-24"
    >
      ...
      <div className="flex flex-col p-4 justify-center max-w-lg mx-auto h-full">
        ...
        <div className="flex justify-center items-center">
          <form
            action="https://api.getform.io/v1/forms/63812acb-570c-4fcf-9f13-0480d903e4fd?token=6qP2Hs2yb8GQeT94GJfocs2ToRusaWOUFkNGwo80Jpz1Wj40ijULhym39tyc"
            method="POST"
